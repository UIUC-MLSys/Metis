...
class IntraStagePlanGenerator:
    ...
    def _next_strategy(self, strategies: List[Tuple[int, int]]) -> Union[List[Tuple[int, int]], None]:
        ...
        # print(f'sorted_stage_id: {sorted_stage_id}')
        # print(f'failed_memory_stage: {self.curr.failed_memory_stage}')
        # if self.curr.failed_memory_stage != []:
        #     # print(f'SWAPPING STAGE {self.curr.failed_memory_stage[0]}')
        #     dp_deg, tp_deg = strategies[self.curr.failed_memory_stage[0]]
        #     if dp_deg != 1:
        #         strategies[self.curr.failed_memory_stage[0]] = (dp_deg // 2, tp_deg * 2)
        #         self.curr.failed_memory_stage.pop(0)
        #         print(f'next_strategy: {strategies}')
        #         print(f'memory_state: {memory_state_dict}')
        #         return strategies
